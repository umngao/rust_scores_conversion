...
if ($#ARGV <5){ die "usage: perl convert_rust_reading.field.pl --typo sample_data_field/typo.field.txt --pheno sample_data_field/pheno_LrAM381_summary_Liang2015.txt --columns 3,4,5,6,7"};
